...
export function classifyTask(task, { fileCount = 0, moduleScope = 'single', ollamaHealthy = false, previousFailedBuilders = [], config = {} } = {}) {
  ...
  if (ollamaHealthy &&
    ...
    return { classification: 'local-trivial-builder', reasons: ['task matches trivial signals', 'Ollama healthy', 'small scope'] };
  }
